# Autogenerated wrapper script for SuperLU_MT_jll for x86_64-w64-mingw32
...
const libsuperlumtc_splitpath = ["bin", "libsuperlumtc.dll"]
...
const libsuperlumtc = "libsuperlumtc.dll"


# Relative path to `libsuperlumtz`
const libsuperlumtz_splitpath = ["bin", "libsuperlumtz.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumtz = "libsuperlumtz.dll"


# Relative path to `libsuperlumts`
const libsuperlumts_splitpath = ["bin", "libsuperlumts.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumts = "libsuperlumts.dll"


# Relative path to `libsuperlumtd`
const libsuperlumtd_splitpath = ["bin", "libsuperlumtd.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumtd = "libsuperlumtd.dll"
