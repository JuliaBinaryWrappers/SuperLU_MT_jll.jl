# Autogenerated wrapper script for SuperLU_MT_jll for x86_64-apple-darwin14
...
const libsuperlumtc_splitpath = ["lib", "libsuperlumtc.dylib"]
...
const libsuperlumtc = "@rpath/complex"


# Relative path to `libsuperlumtz`
const libsuperlumtz_splitpath = ["lib", "libsuperlumtz.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumtz = "@rpath/complex16"


# Relative path to `libsuperlumts`
const libsuperlumts_splitpath = ["lib", "libsuperlumts.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumts = "@rpath/single"


# Relative path to `libsuperlumtd`
const libsuperlumtd_splitpath = ["lib", "libsuperlumtd.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libsuperlumtd = "@rpath/double"
