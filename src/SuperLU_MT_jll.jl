...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SuperLU_MT_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("00982de7-9f76-5194-84e1-476c61fcc171"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SuperLU_MT", artifacts_toml) for e in artifacts["SuperLU_MT"]]
...
if best_platform === nothing
    @debug("Unable to load SuperLU_MT; unsupported platform $(triplet(platform_key_abi()))")
else
